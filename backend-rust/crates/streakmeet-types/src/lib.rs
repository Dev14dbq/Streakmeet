...
pub mod codes {
    ...
    pub const STREAK_NOT_DEAD: &str = "STREAK_NOT_DEAD";
    pub const STREAK_DEAD_FINAL: &str = "STREAK_DEAD_FINAL";
    pub const STREAK_RESTORE_LIMIT: &str = "STREAK_RESTORE_LIMIT";
    pub const STREAK_AD_VERIFY_FAILED: &str = "STREAK_AD_VERIFY_FAILED";
